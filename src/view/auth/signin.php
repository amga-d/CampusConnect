...
<body>
    <form class="form" action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
        ...
        <div class="inputForm">
            ...
            <input type="text" class="input" placeholder="Enter your Email" name="useremail" value="<?php echo $useremail ?>">
        </div>
        ...
        <div class="inputForm">
            ...
            <input type="password" class="input" id="passwordfield" placeholder="Enter your Password" name="password">

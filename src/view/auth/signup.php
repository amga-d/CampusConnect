...
<body>
  ...
  <form class="form "
    ...
    <!-- <div class="logo">
        <img  class="logo1" src="../../assets/img/landing/Logo image.png" alt="">
      <img class="logo2" src="../../assets/img/landing/Logo name.png" alt="">
      </div> -->
    ...
    <div class="inputForm">
      ...
      <input type="text" class="input" name="username" value="<?php echo $username ?>" placeholder="Enter your Name" />
    </div>
    <div class="flex-column">
    ...
    <div class="inputForm">
      ...
      <input type="text" class="input" name="email" value="<?php echo $useremail ?>" placeholder="Enter your Email" />
    </div>
    ...
    <div class="flex-row">
      <button class="btn google" id="googleButton">
        <svg
          version="1.1"
          width="20"
          id="Layer_1"
    ...
    <div class="modal-content">
      ...
      <form id="additionalInfoForm" class="form-layout">

                ...
                <section class="hero" id="about">
                    <div class="hero-wrapper">
                        <div class="hero-content">
                            <h2 class="hero-title">Welcome to CampusConnect</h2>
                            <p class="hero-description">Fostering connections, inspiring growth, and building a vibrant campus community.</p>
                        ...
                        <div class="hero-images">
                            <div class="image-grid">
                                <div class="image-item">
                                    <img class="hero-image"src="https://smvdu.ac.in/wp-content/uploads/2023/11/aGoogle-Developers-Student-Clubs-1.jpg">
                                </div>
                            </div>
                        </div>
                    </div>

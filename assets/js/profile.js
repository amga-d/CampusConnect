document.addEventListener('DOMContentLoaded', function() {
    ...
    const profileImagePreview = document.querySelector('.profile-avatar img');
    ...
    profileImageInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                const previewImages = document.querySelectorAll('.profile-avatar img');
    ...
    function updateProfileUI(formData, newProfileImage) {
        // Update email
        document.querySelector('.info-item:nth-child(1) .info-text p:last-child')
            .textContent = formData.get('email');

        // Update gender
        document.querySelector('.info-item:nth-child(2) .info-text p:last-child')
        ...
        if (birthday) {
            ...
            document.querySelector('.info-item:nth-child(3) .info-text p:last-child')
                .textContent = formattedDate;
        }

        // Update bio
        document.querySelector('.bio-section p')
            .textContent = formData.get('bio');
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape' && editProfileOverlay.classList.contains('active')) {
            closeModal();
        }
    });
});
